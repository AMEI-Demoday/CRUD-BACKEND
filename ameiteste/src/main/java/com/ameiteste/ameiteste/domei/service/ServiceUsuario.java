...
public class ServiceUsuario {
    ...
    public Usuario findById(long id) {
        Usuario usuario = repositorioUsuario.findById(id).orElseThrow(()-> new NegocioExeption(id));
        return usuario;
    }
    ...
    public ResponseEntity<Mensagens> remover (Long id_user){
        repositorioUsuario.deleteById(id_user);
